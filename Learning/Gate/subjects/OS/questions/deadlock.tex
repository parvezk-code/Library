...
\begin{questyle}
  ...
  \begin{choices}
    \choice {\large \(   \sum_{n=1}^{n} s_i < (m * n)  \) }
    \choice {\large \(   \forall i, s_i < m    \) }
    \correctchoice {\large \(   \sum_{n=1}^{n} s_i < (m+n)   \) }
    \choice {\large \(   \forall i, s_i < n   \) }
  \end{choices}
...
\begin{questyle}
  ...
  \begin{choices}
    ...
    \correctchoice {\large \( \mathbf { x_p+x_q >= min_{k!=p,q} \; y_k } \) }

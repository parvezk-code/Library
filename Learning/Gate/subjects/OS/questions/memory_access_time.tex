...
\begin{questyle}
  ...
  \begin{choices}
    \correctchoice {\large \( \mathbf { i + j/k } \) }
...
\begin{questyle}
  ...
  \begin{choices}
    ...
    \correctchoice 1.9999 microseconds
  \end{choices}
...
\begin{questyle}
  ...
  \question  A processor uses 2-level page tables for virtual to physical address translation. Page tables for
            ...
            \begin{choices}
              \choice 1.5 ns
              \choice 2 ns
              \correctchoice 3 ns  (if page table is cached)
              \correctchoice 4 ns  (if page table is not cached)
            \end{choices}

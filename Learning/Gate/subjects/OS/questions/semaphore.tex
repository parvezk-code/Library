  ...
  \begin{parts}
      \part Which of the following will lead to an output string with 001100110011
        \begin{choices}
          ...
          \correctchoice P(S) at W, V(T) at X, P(T) at Y, V(S) at Z, S initially 1, and T initially 0
      ...
      \part Which of the following will ensure that the output string never contains a substring of
        ...
        \begin{choices}
          \choice P(S) at W, V(S) at X, P(T) at Y, V(T) at Z, S and T initially 1
          \choice P(S) at W, V(T) at X, P(T) at Y, V(S) at Z, S and T initially 1
          \correctchoice P(S) at W, V(S) at X, P(S) at Y, V(S) at Z, S initially 1
...
\begin{questyle}
  ...
  \begin{choices}
    ...
    \correctchoice  P(SX), P(SY); P(SX), P(SY)
  \end{choices}
...
\begin{questyle}
  ...
  \begin{choices}
    \correctchoice  The implementation may not work if context switching is disabled in P
  ...
  \begin{parts}
      \part The above implementation of barrier is incorrect. Which one of the following is true?
        \begin{choices}
          ...
          \correctchoice The barrier implementation may lead to a deadlock if two barrier in
invocations are used in immediate succession.
      ...
      \part Which one of the following rectifies the problem in the implementation?
        \begin{choices}
          ...
          \correctchoice At the beginning of the barrier the first process to enter the barrier waits
